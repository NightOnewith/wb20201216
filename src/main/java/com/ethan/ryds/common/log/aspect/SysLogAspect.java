package com.ethan.ryds.common.log.aspect;
...
import com.ethan.ryds.common.utils.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.ethan.ryds.common.log.annotation.RSysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		RSysLog syslog = method.getAnnotation(RSysLog.class);
		if(syslog != null){
			//注解上的描述
